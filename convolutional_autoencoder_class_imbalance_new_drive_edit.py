...
class Network:
    ...
    def __init__(self, net_id, weight=1, layers = None, per_image_standardization=True, batch_norm=True, skip_connections=True):
        ...
        if layers == None:
            layers = []
            layers.append(Conv2d(kernel_size=2, output_channels=64, name='conv_1_1', net_id = net_id))
            ...
            layers.append(Conv2d(kernel_size=2, output_channels=256, name='conv_3_1', net_id = net_id))
            layers.append(Conv2d(kernel_size=2, dilation = 1,  output_channels=256, name='conv_3_2', net_id = net_id))
            ...
            layers.append(Conv2d(kernel_size=2,  output_channels=512, name='conv_4_1', net_id = net_id))
            layers.append(Conv2d(kernel_size=2, output_channels=512, name='conv_4_2', net_id = net_id))
            ...
            layers.append(Conv2d(kernel_size=2, output_channels=512, name='conv_5_1', net_id = net_id))
            layers.append(Conv2d(kernel_size=2, output_channels=512, name='conv_5_2', net_id = net_id))
            ...
            layers.append(Conv2d(kernel_size=1, output_channels=4096, name='conv_6_1', net_id = net_id))
