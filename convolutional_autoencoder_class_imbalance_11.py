...
def train(train_indices, validation_indices, run_id):
    ...
    with tf.device('/gpu:1'):
        ...
        network = Network(net_id = count, weight=11)
    count +=1
        ...
        with tf.device('/gpu:0'):
            ...
            for epoch_i in range(n_epochs):
                ...
                for batch_i in range(dataset.num_batches_in_epoch()):
                    ...
                    print('{}/{}, epoch: {}, cost: {}, batch time: {}, positive_weight: {}'.format(batch_num, n_epochs * dataset.num_batches_in_epoch(), epoch_i, cost, end - start, 11))
